...
native 与 trusted Python `network=none` AppContainer/no-network、trusted Python disposable staged base-executable、Job Object 单 native runtime 上限、workspace ACL、一次性 runtime staging ACL、brokered exact loopback WFP 与 native-or-fail-closed CI gate。
