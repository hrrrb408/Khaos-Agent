...
- `python/khaos/security/production_composition_probe.py:108` `subprocess.Popen` in `<module>._spawn_probe_process` owner=`ProductionCompositionProbe` threat-model=`compose-job-identity` boundary=`production-compose-e2e`
