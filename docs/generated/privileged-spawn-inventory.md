...
- `python/khaos/security/production_composition_probe.py:88` `subprocess.Popen` in `<module>.main` owner=`ProductionCompositionProbe` threat-model=`compose-job-identity` boundary=`production-compose-e2e`
