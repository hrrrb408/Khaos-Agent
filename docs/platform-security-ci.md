...
| `Platform Sandbox Security E2E / macos-sandbox-security` | macOS hosted runner | sandbox-exec workspace-write、外部写拒绝、禁网、secret root、pasteboard/Keychain IPC 拒绝 | Linux namespace |
