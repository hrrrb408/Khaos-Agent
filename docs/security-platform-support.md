...
| Windows | Supported when the native helper probe passes | restricted token + Job Object limited to one native runtime process (outer helper owns cleanup) + transactional workspace ACL + WFP-backed Firewall; missing evidence fails closed |
