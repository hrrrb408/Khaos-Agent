...
def render() -> str:
    ...
    source_fingerprints = [
        ...
        ("python/khaos/coding/execution/resource_owner.py", sha256(ROOT / "python" / "khaos" / "coding" / "execution" / "resource_owner.py")),
        ...
        ("python/khaos/security/production_trust.py", sha256(ROOT / "python" / "khaos" / "security" / "production_trust.py")),
        ("python/khaos/security/authorityd.py", sha256(ROOT / "python" / "khaos" / "security" / "authorityd.py")),
        ("python/khaos/security/authorityd_main.py", sha256(ROOT / "python" / "khaos" / "security" / "authorityd_main.py")),
        ("python/khaos/security/authorityd_protocol.py", sha256(ROOT / "python" / "khaos" / "security" / "authorityd_protocol.py")),
        ("python/khaos/security/authorityd_windows.py", sha256(ROOT / "python" / "khaos" / "security" / "authorityd_windows.py")),
        ("python/khaos/security/authority_transport.py", sha256(ROOT / "python" / "khaos" / "security" / "authority_transport.py")),
        ("python/khaos/security/local_trust.py", sha256(ROOT / "python" / "khaos" / "security" / "local_trust.py")),
        ...
        ("python/khaos/security/native_authority.py", sha256(ROOT / "python" / "khaos" / "security" / "native_authority.py")),
        ("python/khaos/security/protocol_boundary.py", sha256(ROOT / "python" / "khaos" / "security" / "protocol_boundary.py")),
        ("python/khaos/security/production_composition_manifest.py", sha256(ROOT / "python" / "khaos" / "security" / "production_composition_manifest.py")),
        ...
        ("python/khaos/scheduler/execution.py", sha256(ROOT / "python" / "khaos" / "scheduler" / "execution.py")),
        ("python/khaos/scheduler/recovery.py", sha256(ROOT / "python" / "khaos" / "scheduler" / "recovery.py")),
        ...
        ("python/khaos/rpc/composition.py", sha256(ROOT / "python" / "khaos" / "rpc" / "composition.py")),
