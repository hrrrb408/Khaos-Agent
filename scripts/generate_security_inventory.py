...
def render() -> str:
    ...
    lines.extend([
        ...
        "| Windows | Native restricted-token/AppContainer/Job/ACL/WFP helper; native commands use AppContainer while trusted Python uses restricted-token + exact WFP image block/runtime-file ACLs; missing probe evidence refuses Host fallback | Windows native CI gate |",
